...
import 'SignOtpVerify.dart';

class SignupNumberFeild extends StatefulWidget {
  const SignupNumberFeild({super.key});

  @override
  State<SignupNumberFeild> createState() => _SignupNumberFeildState();
}

class _SignupNumberFeildState extends State<SignupNumberFeild> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(onTap: (){ Navigator.of(context).push(MaterialPageRoute(builder: (_)=> SignUpOtpverify()));},
                      child: Center(
                        child: Container(
                          width: 100.w,
                          height: 48.h,
